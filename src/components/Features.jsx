...
const BentoCard = ({ source, title, description }) => {
	return (
		<div className="relative size-full">
			...
			<div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
				<div>
					...
					{description && (
						<p className="mt-10 max-w-64 text-xs md:text-base">{description}</p>
					)}
				</div>
			</div>
		</div>
			...
			<div className="container mx-auto px-3 md:px-10">
				<div className="px-5 py-32">
					...
					<p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
						...
						array of products converge into an interconnected overlay of
						experience
					</p>
				</div>
				...
				<div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
					...
					<div className="bento-tilt-2">
						<div className="flex size-full flex-col justify-between bg-violet-300 p-5">
							<h1 className="bento-title special-font max-w-64 text-black select-none">M<b>o</b>re Co<b>m</b>ing So<b>o</b>n!</h1>
