...
const Hero = () => {
	...
	const handleMiniVideoClick = () => {
		...
		setVideoPlaying((prevIndex) => (prevIndex % totalVideo) + 1);
	};
	...
	useGSAP(() => {
		gsap.set("#video-frame", {
			clipPath: "polygon(14% 0%, 72% 0%, 83% 90%, 0% 95%)",
				...
				<div>
					<div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
						...
						>
							<video
								ref={nextVideoRef}
								src={videoSource((videoPlaying % totalVideo) + 1)}
								loop
								muted
								id="current-video"
					...
					<video
						src={videoSource(
							videoPlaying === totalVideo - 1 ? 1 : videoPlaying
						)}
						autoPlay
						loop
						muted
